...
psql -U audit_admin -h localhost -d auditlog_db_example -f migrations/V4__apply_triggers_to_tables.sql

# Aplicar extensiones en orden
psql -U audit_admin -h localhost -d auditlog_db_example -f extensions/V5__create_audit_history_view.sql
psql -U audit_admin -h localhost -d auditlog_db_example -f extensions/V6__create_get_record_at_function.sql

# Poblar datos de prueba
psql -U audit_admin -h localhost -d auditlog_db_example -f seeds/seed_ecommerce_data.sql
...
psql -U audit_admin -h localhost -d auditlog_db_example -f queries/test_audit_operations.sql

# Ejecutar script de consultas de ejemplo para auditoria
psql -U audit_admin -h localhost -d auditlog_db_example -f queries/example_audit_queries.sql
